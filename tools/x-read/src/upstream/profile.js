  ...
  func: async (page, kwargs) => {
    ...
    const rawResult = unwrapBrowserResult(await ((__bb_static_arg_0, __bb_static_arg_1, __bb_static_arg_2, __bb_static_arg_3) => page.evaluate(() => {
      const __bb_value = async () => {
        ...
        const operation = __bb_static_arg_2;
        ...
        const url = '/i/api/graphql/' + operation.queryId + '/UserByScreenName?variables=' + encodeURIComponent(variables) + '&features=' + encodeURIComponent(features);
        let resp;
        try {
