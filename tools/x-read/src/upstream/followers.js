// Private repair: use observed Followers API directly instead of fragile DOM-link navigation/interception.
...
const FOLLOWING_QUERY_ID = 'sF7aRC2fRq7OGOOp_qHntA';
...
cli({
  ...
  func: async (page, kwargs) => {
    ...
    for (let i = 0; i < MAX_PAGINATION_PAGES && allUsers.length < limit; i++) {
      ...
      headers={...headers,'X-Client-Transaction-Id':await gen('x.com',new URL(url,location.href).pathname,'GET')};
