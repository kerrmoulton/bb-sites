 ...
 */
import { cli, Strategy, commands } from '@jackwener/opencli/registry';
import './thread.js';
...
import { resolveTwitterOperationMetadata, normalizeTwitterGraphqlPayload, unwrapBrowserResult, normalizeTwitterScreenName, extractMedia, parseTweetUrl } from './shared.js';
...
async function downloadSingleTweet(page, tweetUrl, output) {
  ...
  // Reuse read-only TweetDetail parsing; never collect media from unrelated reply DOM.
