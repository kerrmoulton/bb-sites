/* @meta
{
  "name": "twitter/read-bookmark-folders",
  "description": "Private BB read adapter: List your Twitter/X bookmark folders (the user-created collections under Bookmarks). Returns folder id, name, item count, and created_at.",
  "domain": "x.com",
  "readOnly": true,
  "args": {
    "request": {
  ...
  "example": "bb-browser site twitter/read-bookmark-folders --json"
}
*/
...
var XRead = (() => {
  ...
  // src/upstream/bookmark-folders.js
  var OPERATION_NAME = "BookmarkFoldersSlice";
  var FALLBACK_QUERY_ID = "i78YDd0Tza-dV4SYs58kRg";
  var FEATURES = {
...
return XRead.runRead("bookmark-folders",args);
}
