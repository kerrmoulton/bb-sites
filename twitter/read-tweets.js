/* @meta
{
  "name": "twitter/read-tweets",
  "description": "Private BB read adapter: Fetch a Twitter user's most recent tweets (chronological, excludes pinned; defaults to the logged-in user when no username is given)",
  "domain": "x.com",
  "readOnly": true,
  "args": {
    "request": {
  ...
  "example": "bb-browser site twitter/read-tweets --json"
}
*/
...
var XRead = (() => {
  ...
  // src/upstream/tweets.js
  var MAX_TWEETS_LIMIT = MAX_USER_TWEETS_LIMIT;
  var DEFAULT_PAGE_DELAY_SECONDS = DEFAULT_USER_TWEETS_PAGE_DELAY_SECONDS;
...
return XRead.runRead("tweets",args);
}
